...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        arrowImage = new ImageIcon("C:\\Users\\ZEYNEP BÖLÜKBAŞI\\IdeaProjects\\HMW_1\\src\\main\\resources\\images\\keyboardArrow.png");
        arrowImage.paintIcon(this, g, 670, 560);
        g.setFont(new Font("Helvetica", Font.PLAIN, 16));
        g.drawString("Movement", 770, 590);

        shiftImage = new ImageIcon("C:\\Users\\ZEYNEP BÖLÜKBAŞI\\IdeaProjects\\HMW_1\\src\\main\\resources\\images\\shift.png");
        shiftImage.paintIcon(this, g, 695, 625);
        g.drawString("Boost", 770, 640);

        // instansiasi gambar buat kepala ular
        snakeHead = new ImageIcon("C:\\Users\\ZEYNEP BÖLÜKBAŞI\\IdeaProjects\\HMW_1\\src\\main\\resources\\images\\snakeHead4.png");
        ...
        for (int i = 0; i < snake.lengthOfSnake; i++) {
            if (i == 0 && (snake.right || snake.left || snake.up || snake.down)) {
                snakeHead = new ImageIcon("C:\\Users\\ZEYNEP BÖLÜKBAŞI\\IdeaProjects\\HMW_1\\src\\main\\resources\\images\\apple4.png");
                snakeHead.paintIcon(this, g, snake.snakexLength[i], snake.snakeyLength[i]);
            }
            if (i != 0) {
                snakeBody = new ImageIcon("C:\\Users\\ZEYNEP BÖLÜKBAŞI\\IdeaProjects\\HMW_1\\src\\main\\resources\\images\\snakeimage4.png");
                snakeBody.paintIcon(this, g, snake.snakexLength[i], snake.snakeyLength[i]);
            }
        }

        appleImage = new ImageIcon("C:\\Users\\ZEYNEP BÖLÜKBAŞI\\IdeaProjects\\HMW_1\\src\\main\\resources\\images\\apple4.png");
